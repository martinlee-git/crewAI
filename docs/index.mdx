...
title: "CrewAI 문서" 설명: "협업 AI 에이전트, 팀 및 흐름을 구축하세요. 첫날부터 제작 준비가 완료됩니다." icon: "house" 모드: "wide" <div style={{ 디스플레이: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, textAlign: 'center', padding: '48px 24px', borderRadius: 16, background: 'lineargradient(180deg, rgba(235,102,88,0.12) 0%, rgba(201,76,60,0.08) 100%)', border: '1px solid rgba(235,102,88,0.18)' }} <img src="/images/crew only logo.png" alt="CrewAI" width="250" height="100" / <div style={{ maxWidth: 720 }} <h1 style={{ marginBottom: 12 }} 안심하고 다중 에이전트 시스템 출시</h1 <p style={{ color: 'var( mint text 2)' }} 가드레일, 메모리, 지식 및 내장된 관찰 가능성을 통해 에이전트를 설계하고 팀을 조율하고 흐름을 자동화합니다. </p </div <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'center' }} <a className="button 버튼 기본" href="/en/quickstart" 시작하기</a <a className="button" href="/en/changelog" Vie
