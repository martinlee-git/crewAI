...
crewai files File handling utilities for CrewAI multimodal inputs. 지원되는 파일 형식 ImageFile PNG, JPEG, GIF, WebP PDFFile PDF 문서 TextFile 일반 텍스트 파일 AudioFile MP3, WAV, FLAC, OGG, M4A VideoFile MP4, WebM, MOV, AVI 사용법 제작진에게 파일 전달 작업에 파일 전달
